...
/**
 * This test group is for a User with 'User' privileges, a single company/branch, and all account options
 * Class userAddClientsWithAllAccountOptionsTest
 * @package Tests\Browser
 */
class userAddClientsWithAllAccountOptionsTest extends DuskTestCase
{
